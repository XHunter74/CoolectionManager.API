...
public class CreatePossibleValueCommand : ICommand<PossibleValue?>
{
...
public class CreatePossibleValueCommandHandler : ICommandHandler<CreatePossibleValueCommand, PossibleValue?>
{
    ...
    public async Task<PossibleValue?> HandleAsync(CreatePossibleValueCommand command, CancellationToken cancellationToken)
    {
        ...
        var possibleValue = new PossibleValue { Id = Guid.NewGuid(), Value = command.Value, CollectionFieldId = command.FieldId };
